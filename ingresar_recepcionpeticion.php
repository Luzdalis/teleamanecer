...
mysql_query ("INSERT INTO recepcionpeticion(nombre,apellido,peticion,fecha,hora) values ('$nombre','$apellido','$peticion','$fecha','$hora')",$conexion);

echo"<script>
alert('Enviado satisfactoriamente')
location.href='peticion.html'; 
</script>";
