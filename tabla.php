...
.Estilo101 {font-size: 24px; font-family: "Matura MT Script Capitals";}
.Estilo103 {font-size: 24px; font-family: "Matura MT Script Capitals"; color: #FF6600; }
...
.Estilo117 {font-size: 18px; font-family: "Harlow Solid Italic"; }
.Estilo118 {
	font-family: "Comic Sans MS";
	font-size: 12;
}
.Estilo119 {font-size: 12px}
.Estilo120 {font-family: "Comic Sans MS"; font-size: 12px; }
.Estilo121 {
...
.Estilo23 {font-family: "Arial Black", "Comic Sans MS"}
.Estilo26 {font-size: 18px}
.Estilo28 {font-family: Arial, Helvetica, sans-serif; font-size: 18px; }
.Estilo30 {font-size: 24px; color: #FF080E; font-family: "Monotype Corsiva"; }
...
<table width="787" height="" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    <td colspan="5" bgcolor="#000000" class="Estilo6"><table width="780" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td colspan="2" bgcolor="#FFFFFF"><span class="Estilo101"><span class="Estilo109"> A</span><span class="Estilo108">manecer 101.9 FM</span></span></td>
        <td width="180" bgcolor="#FFFFFF"><span class="Estilo117"><a href="programacion.html">Programaci&oacute;n </a></span></td>
        <td width="221" bgcolor="#FFFFFF"><a href="requisitos_programa.html" class="Estilo117">Requisitos Programa</a></td>
        <td colspan="3" bgcolor="#FFFFFF"><a href="requisitos_publicidad.html" class="Estilo117">Requisitos Publicidad</a></td>
        </tr>
      <tr>
        <td width="123" bgcolor="#FFFFFF"><div align="right"><a href="http://www.unanimesjuntos.com/radio12.html" target="_blank"><img src="imagenes/logoradio_peq.jpg" width="100" height="52" border="0" /></a></div></td>
        <td width="83" bgcolor="#FFFFFF"><div align="center">
          <p class="Estilo178"><span class="Estilo120"><strong>Se&ntilde;al en Vivo </strong>Clic sobre la Imagen </span></p>
          </div></td>
        <td colspan="3" bgcolor="#FFFFFF"><div align="center"><span class="Estilo101"> <span class="Estilo179 Estilo121">&iexcl;Sintoniza y Visualizaza las Se&ntilde;ales de Prestigio!</span></span></div></td>
        <td width="86" bgcolor="#FFFFFF"><div align="center"><span class="Estilo178 Estilo118 Estilo119"><strong>Se&ntilde;al en Vivo </strong>Clic sobre la Imagen </span></div></td>
        <td width="86" bgcolor="#FFFFFF"><span class="Estilo101"><a href="http://www.circuitoluzdelmundo.com/tvptofj.php" target="_blank"><img src="imagenes/logotv_peq.jpg" width="60" height="57" border="0" /></a></span></td>
      </tr>
      <tr>
        <td colspan="7" bgcolor="#000000"><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="780" height="197" align="middle">
          <param name="movie" value="flash/banner_funda.swf" />
          <param name="quality" value="high" />
          <embed src="flash/banner_funda.swf" width="780" height="197" align="middle" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash"></embed>
        </object></td>
        </tr>  
    </table> </td>
  </tr>
  ...
  <tr>
    <td height="21" colspan="3" background="imagenes/entre2.jpg" class="Estilo6"><div align="center"><span class="Estilo98">P&aacute;ginas de Inter&eacute;s </span></div></td>
  </tr>
  <tr>
    <td width="54" height="19" bgcolor="#41718C" class="Estilo6"><p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p></td>
    <td width="677" background="imagenes/tabla1.gif" bgcolor="#FFFFFF" class="Estilo6"><div align="center">
      <p>&nbsp;</p>
      <blockquote>
        <p align="center" class="Estilo30"><span class="Estilo23"><span class="Estilo31"><span class="Estilo26"><a href="http://www.obraluzdelmundo.com" target="_blank"></a></span></span></span></p>
        <p align="center" class="Estilo30"><?
include "conectar.php";

$id=$HTTP_POST_VARS[id];
$sql="select * from claveacceso where id=$id";
$p=mysql_query($sql,$conexion);
$res=mysql_fetch_array($p);

echo"
<form id='form1' name='form1' method='post' action='modificar_usuario.php' onSubmit='return validacion(this)'>
<table width='200' background='imagenes/tabla.jpg' border='0' align='center'>
  <tr>
  <th colspan ='2'><font size='1' fase='Arial' color='#FFFFFF'>MODIFICAR USUARIO</font></th></tr>

  <tr> 
  <td width='96' <strong><colspan='1'><font size='1' face='Arial' color='#FFFFFF'>CEDULA:</font></strong></td>
  <td  width='258' height='20' class=row2><div align='left'><input name='cedula' type='text' id='cedula' value='$res[cedula]'  size=10>
  </div></td></tr>
  
  <tr> 
  <td <strong><colspan='1'><font size='1' face='Arial' color='#FFFFFF'>NOMBRE:</font></strong></td>
  <td class=row2><div align='left'><input name='usuario' type='text' id='usuario' value='$res[usuario]'  size=10>
  </div></td></tr>
   
  <tr> 
  <td <strong><colspan='1'><font size='1' face='Arial' color='#FFFFFF'>APELLIDO:</font></strong></td>
  <td class=row2><div align='left'><input name='apellido' type='text' id='apellido'  value='$res[apellido]'  size=10>
  </div></td></tr>
  
  <tr> 
  <td <strong><colspan='1'><font size='1' face='Arial' color='#FFFFFF'>CLAVE:</font></strong></td>
  <td class=row2><div align='left'><input name='clave' type='text' id='clave' value='$res[clave]'  size=10>
  </div></td></tr>
  
  <tr>
  <td height='33' class=row2><div align='right'>
  <input name='submit' type='submit' value='Cambiar'></div></td>
  <input type='HIDDEN' name='id' value='$id'>

  <td height='33' class=row2><div align='center'>
  <input name='cancel' type='reset' id='cancel' value ='Cancelar'></div></td>
  </tr>
...
?></p>
    ...
    <td width="54" bgcolor="#41718C" class="Estilo6">&nbsp;</td>
  </tr>
  
  <tr>
    <td colspan="3" bgcolor="#41718C" class="Estilo6"><p>&nbsp;</p>
    <p>&nbsp;</p>
    <p align="center"><a href="opciones_reportes.html"><img src="imagenes/TgC_flechas_81.gif" width="45" height="44" border="0" /></a></p>
    <p>&nbsp;</p></td>
  </tr>
