...
$sql=mysql_query("select * from locutor",$conexion);

$array_datos = mysql_fetch_row ($sql);
					if (!$array_datos)
					{
					  echo" <b><div align='center'<colspan='1'><font size='3' face='Arial' color='#000000'>¡Disculpe, no hay Locutores Autorizados!</font></div></b>";
					}//if

else{

echo"
<table align= center class= forumline border='0' width='334' cellspacing ='0' cellpadding='3'>
<b><div align='center'<colspan='1'><font size='3' face='Arial' color='#000000'>LOCUTORES AUTORIZADOS</font></div></b>
<p>&nbsp;</p>";
...
<table width='75%' border='1' bordercolor='#000000' align='center'>
  <tr bgcolor='#000000'>
  <th colspan ='1'><font size='2' fase='Arial' color='#FFFFFF'>CEDULA</font></th>
  <th colspan ='1'><font size='2' fase='Arial' color='#FFFFFF'>NOMBRE</font></th>
  <th colspan ='1'><font size='2' fase='Arial' color='#FFFFFF'>APELLIDO</font></th>
  <th colspan ='1'><font size='2' fase='Arial' color='#FFFFFF'>CLAVE</font></th>
  <th colspan ='2'><font size='2' fase='Arial' color='#FFFFFF'>ACTUALIZAR</font></th>";
...
while($res=mysql_fetch_array($sql))
{
 echo"
 <tr bgcolor='#99FFFF'>
 <td><font size='2' fase='Arial' color='#000000'>",$res[cedula],"</font></td> 
 <td><font size='2' fase='Arial' color='#000000'>",$res[nombre],"</font></td>
 <td><font size='2' fase='Arial' color='#000000'>",$res[apellido],"</font></td>
 <td><font size='2' fase='Arial' color='#000000'>",$res[clave],"</font></td>
 
  <td bgcolor='#99FFFF'>
   <form name='form1' method='post' action='tabla_locutor.php'>
    <p align='center'><input type ='submit' name='submit2' value='Modificar'> 
   <input type=HIDDEN name='id' value='$res[id]'></p> </form> </td>
 
 <td bgcolor='#99FFFF'>
   <form name='form1' method='post' action='eliminar_locutor.php'>
    <p align='center'><input type ='submit' name='submit2' value='Borrar'> 
   <input type=HIDDEN name='id' value='$res[id]'></p> </form> </td>
