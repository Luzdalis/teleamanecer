...
$sql=mysql_query("select * from claveacceso",$conexion);

$array_datos = mysql_fetch_row ($sql);
					if (!$array_datos)
					{
					  echo" <b><div align='center'<colspan='1'><font size='3' face='Arial' color='#000000'>¡Disculpe, no hay Usuarios Autorizados!</font></div></b>";
					}//if
...
<b><div align='center'<colspan='1'><font size='3' face='Arial' color='#000000'>USUARIOS AUTORIZADOS</font></div></b>
<p>&nbsp;</p>";
