...
$res="UPDATE locutor  set  cedula='$cedula', nombre='$nombre', apellido='$apellido', clave='$clave'  where  id='$id'";
$p=mysql_query($res,$conexion);

echo"<script>
alert('Registro modificado éxitosamente')
location.href='mostrar_moderadores.php'; 
</script>";
...
?></p>
  ...
  <tr>
    ...
    <p>&nbsp;</p>
    <p align="center"><a href="mostrar_moderadores.php"><img src="imagenes/TgC_flechas_81.gif" width="45" height="44" border="0" /></a></p>
    <p>&nbsp;</p></td>
  </tr>
