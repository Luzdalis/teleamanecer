...
$sql=mysql_query("select * from recepcionpeticion",$conexion);

$array_datos = mysql_fetch_row ($sql);
					if (!$array_datos)
					{
					  echo" <b><div align='center'<colspan='1'><font size='3' face='Arial' color='#000000'>¡Disculpe, no hay peticiones por mostrar!</font></div></b>";
					}//if
...
<b><div align='center'<colspan='1'><font size='3' face='Arial' color='#000000'>RECEPCI&Oacute;N DE PETICI&Oacute;N DE ORACI&Oacute;N</font></div></b>
<p>&nbsp;</p>";

echo"
<table width='75%' border='1' bordercolor='#000000' align='center'>
  <tr bgcolor='#000000'>
  <th colspan ='1'><font size='2' fase='verdana' color='#FFFFFF'>NOMBRE</font></th>
  <th colspan ='1'><font size='2' fase='verdana' color='#FFFFFF'>APELLIDO</font></th>
  <th colspan ='1'><font size='2' fase='verdana' color='#FFFFFF'>PETICION</font></th>
  <th colspan ='1'><font size='2' fase='verdana' color='#FFFFFF'>FECHA</font></th>
  <th colspan='1'> <font size='2' face='verdana' color='#FFFFFF'> ACTUALIZAR</font></th>";
...
while($res=mysql_fetch_array($sql))
{
 ...
 <td bgcolor='#99FFFF'>
   <form name='form1' method='post' action='eliminar3.php'>
