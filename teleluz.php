...
.Estilo210 {	font-family: Georgia, "Times New Roman", Times, serif;
	font-size: 14px;
	color: #FFFFFF;
}
.Estilo211 {	font-family: "Script MT Bold", Tahoma;
	font-size: 18px;
	color: #FFFFFF;
}
...
<table width="770" height="" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    <td colspan="5" bgcolor="#000000" class="Estilo6"><table width="780" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td width="86" bgcolor="#FFFFFF"><span class="Estilo101"><a href="teleluz.html" target="_blank"><img src="imagenes/logotv_peq.jpg" width="60" height="57" border="0" /></a></span></td>
      </tr>
      <tr>
  ...
  <tr>
    <td height="21" colspan="3" background="imagenes/entre2.jpg" class="Estilo6"><div align="center"><span class="Estilo98">Televisi&oacute;n  en Vivo TeleLuz Canal 21 </span></div></td>
  </tr>
  <tr>
    ...
    <p>&nbsp;</p>
    <p>&nbsp;</p></td>
    <td width="678" bgcolor="#FFFFFF" class="Estilo6"><div align="center">
      <p>&nbsp;</p>
      <table id="reproductortv" width="570" height="431" border="0" cellpadding="0" cellspacing="0" align="center">
        <tr>
          <td colspan="3"><img src="tvonline/images/reproductor_01.jpg" width="570" height="35" /></td>
        </tr>
        <tr>
          <td><img src="tvonline/images/reproductor_02.jpg" width="35" height="375" /> </td>
          <td><!-- copie desde aqui para insertar reproductor en su sitio web -->
...
?>
            <object id="player" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" name="player" width="501" height="375">
                <param name="movie" value="tvonline/player.swf" />
          ...
          <td><img src="tvonline/images/reproductor_04.jpg" width="34" height="375" /></td>
        </tr>
        <tr>
          <td colspan="3"><img src="tvonline/images/reproductor_05.jpg" width="570" height="115" alt="Powered by grservicesonline.com" /></td>
        </tr>
      </table>
      <p>&nbsp;</p>
    </div></td>
    <td width="38" bgcolor="#41718C" class="Estilo6">&nbsp;</td>
  </tr>
