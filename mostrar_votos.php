...
<table width="778" height="" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    <td colspan="5" bgcolor="#000000" class="Estilo6"><table width="780" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="123" bgcolor="#FFFFFF"><div align="right"><a href="radio_amanecer.html" target="_blank"><img src="imagenes/logoradio_peq.jpg" width="100" height="52" border="0" /></a><a href="http://www.unanimesjuntos.com/radio12.html" target="_blank"></a></div></td>
        ...
        <td width="86" bgcolor="#FFFFFF"><span class="Estilo101"><a href="teleluz.html" target="_blank"><img src="imagenes/logotv_peq.jpg" width="60" height="57" border="0" /></a><a href="http://www.circuitoluzdelmundo.com/tvptofj.php" target="_blank"></a></span></td>
      </tr>
      <tr>
  ...
  <tr>
    <td height="21" colspan="3" background="imagenes/entre2.jpg" class="Estilo6"><div align="center"><span class="Estilo98">Mostrar Votos </span></div></td>
  </tr>
  <tr>
    ...
    <p>&nbsp;</p>
    <p>&nbsp;</p></td>
    <td width="678" background="imagenes/tabla1.gif" bgcolor="#FFFFFF" class="Estilo6"><div align="center"><?

include "conectar.php";

$sql=mysql_query("select * from votar",$conexion);

$array_datos = mysql_fetch_row ($sql);
					if (!$array_datos)
					{
					  echo" <b><div align='center'<colspan='1'><font size='3' face='Arial' color='#000000'>¡Disculpe, no hay Votos que mostrar!</font></div></b>";
					}//if
...
<b><div align='center'<colspan='1'><font size='3' face='Arial' color='#000000'>RESULTADOS</font></div></b>
<p>&nbsp;</p>";


echo"
<table width='200' border='1' bordercolor='#000000' align='center'>
  <tr bgcolor='#000000'>
  <th colspan ='1'><font size='2' fase='Arial Black' color='#FFFFFF'>VOTOS MALO</font></th>
  <th colspan ='1'><font size='2' fase='Arial Black' color='#FFFFFF'>VOTOS REGULAR</font></th>
  <th colspan ='1'><font size='2' fase='Arial Black' color='#FFFFFF'>VOTOS BUENO</font></th>
  <th colspan ='1'><font size='2' fase='Arial Black' color='#FFFFFF'>VOTOS EXCELENTE</font></th>";
...
while($res=mysql_fetch_array($sql))
{
 ...
 if     (strlen($res.voto)=="Malo") {$cont1++;}
 elseif (strlen($res.voto)=="Regular") {$cont2++;}
 elseif (strlen($res.voto)=="Bueno") {$cont3++;}
 else {$cont4++;}
 }//while			 
					  
 echo"
 <tr bgcolor='#99FFFF'>
 <td><font size='2' fase='Arial' color='#000000'>",$cont1,"</font></td> 
 <td><font size='2' fase='Arial' color='#000000'>",$cont2,"</font></td>
 <td><font size='2' fase='Arial' color='#000000'>",$cont3,"</font></td>
 <td><font size='2' fase='Arial' color='#000000'>",$cont4,"</font></td>
 </tr> ";
...
?></div></td>
    <td width="46" bgcolor="#41718C" class="Estilo6">&nbsp;</td>
  </tr>
