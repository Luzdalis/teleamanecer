...
<!-- Validar edad-->  
 if (formulario.edad.value.length < 1)
  ...
  if (!validar)
  {
    alert("Este campo debe contener solo números");
    formulario.edad.focus();
    return (false);
  }
    ...
    <td width="695" background="imagenes/tabla1.gif" bgcolor="#FFFFFF" class="Estilo6"><div align="center">
      ...
      <blockquote>
        <p align="center" class="Estilo86"><?
					...
					if (!$array_datos)
					{
					  echo" <b><div align='center'<colspan='1'><font size='3' face='Arial' color='#000000'>¡Disculpe, en este momento no hay concurso en línea!</font></div></b>";
					}//if
